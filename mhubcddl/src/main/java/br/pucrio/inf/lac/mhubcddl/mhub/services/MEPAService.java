...
import br.pucrio.inf.lac.mhubcddl.mhub.databases.CEPRulesDataSource;
import br.pucrio.inf.lac.mhubcddl.mhub.databases.EventTypesDataSource;
import br.pucrio.inf.lac.mhubcddl.mhub.models.CEPRule;
import br.pucrio.inf.lac.mhubcddl.mhub.models.EventType;
import br.pucrio.inf.lac.mhubcddl.mhub.models.base.QueryMessage;
import br.pucrio.inf.lac.mhubcddl.mhub.models.locals.EventData;
import br.pucrio.inf.lac.mhubcddl.mhub.models.locals.MessageData;
import br.pucrio.inf.lac.mhubcddl.mhub.models.locals.SensorData;
import br.pucrio.inf.lac.mhubcddl.mhub.models.queries.MEPAQuery;
import br.pucrio.inf.lac.mhubcddl.mhub.services.listeners.MEPAListener;
...
public class MEPAService extends Service {
     ...
     */
    private boolean addRule(String label, String rule) {
        return addRule(label, rule, QueryMessage.ROUTE.GLOBAL);
    }
     ...
     * @return true if no error presented
     */
    private boolean addRule(String label, String rule, QueryMessage.ROUTE target) {
        ...
        try {
            ...
            MEPAListener listener = new MEPAListener(label, target);
            statement.addListener(listener);
