package br.pucrio.inf.lac.mhubcddl.mhub.s2pa.technologies.internal;
...
import br.pucrio.inf.lac.mhubcddl.mhub.s2pa.technologies.internal.devices.SensorPhone;
...
public class InternalTechnology implements Technology {
    ...
    private SensorPhone mConnectedDevice;
    ...
    @Override
    public void enable() {
        mConnectedDevice = new SensorPhone(ac, ID, listener);
        mConnectedDevice.enable();
    }
