package br.pucrio.inf.lac.mhubcddl.mhub.s2pa.base;
...
public interface TechnologyListener {
     ...
     * @param rssi         The RSSI value for the mobile object
     * @param serviceName  The service name e.g. Temperature
     * @param value        The values read for the service
     */
    void onMObjectValueRead(MOUUID mobileObject, Double rssi, String serviceName, SensorDataExtended value);
