package br.pucrio.inf.lac.mhubcddl.mhub.broadcastreceivers;
...
public class PowerReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context c, Intent i) {
        ...
        Intent iLoc = new Intent(BroadcastMessage.ACTION_CHANGE_LOCATION_INTERVAL), iConn = new Intent(BroadcastMessage.ACTION_CHANGE_MESSAGES_INTERVAL), iScan = new Intent(BroadcastMessage.ACTION_CHANGE_SCAN_INTERVAL);
        // get the action
