 ...
 */
@SuppressLint("NewApi")
public abstract class BTMobileObject {
    ...
    public synchronized void onDisconnected() {
        if (isConnected()) {
            ...
            outpuStream = null;
            if (btTechnologyListener != null) {
                btTechnologyListener.onMObjectDisconnected(getMouuid(), getServices());
            }
        }
    }

    protected void onValueRead(String contextInformation, Double[] values) {
        btTechnologyListener = BTTechnology.getInstance().getTechnologyListener();
        if (btTechnologyListener != null) {
            btTechnologyListener.onMObjectValueRead(getMouuid(), getRssi(), contextInformation, values);
        }
    }
    ...
    public abstract void readSensorValue(String sensorName);

    public abstract void writeSensorValue(String sensorName, Object value);
