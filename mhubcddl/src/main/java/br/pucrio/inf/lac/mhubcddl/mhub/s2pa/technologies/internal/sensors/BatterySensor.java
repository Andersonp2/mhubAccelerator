...
public class BatterySensor implements InternalSensor {
    ...
    private final String SENSOR_NAME = "Battery";
    ...
    private class BatterySensorTask extends
        ...
        protected Void doInBackground(InternalSensorListener... params) {
            ...
            while (true) {
                ...
                data.setSensorName(SENSOR_NAME);
                data.setSensorObjectValue(battPercent);

                data.setMeasurementTime(System.currentTimeMillis());
                data.setAvailableAttributes(1);
         ...
         */
        @Override
        protected void onProgressUpdate(SensorDataExtended... values) {
            listener.onInternalSensorChanged(values[0]);
        }
