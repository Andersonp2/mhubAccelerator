...
public abstract class HXM030655_AbstractSensor implements TechnologySensor {
    ...
    /*     */
/*     */
    public HXM030655_AbstractSensor() {
    }

    public HXM030655_AbstractSensor(String name) {
        this.name = name;
    }
